...
namespace gps
{
    ...
    void ParticleRenderer::init()
    {
        ...
        glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, sizeof(ParticleInstanceData), (GLvoid *) offsetof(ParticleInstanceData, col0));
        glEnableVertexAttribArray(2);
        glVertexAttribDivisor(2, 1);
        glVertexAttribPointer(2, 4, GL_FLOAT, GL_FALSE, sizeof(ParticleInstanceData), (GLvoid *) offsetof(ParticleInstanceData, col1));
        glEnableVertexAttribArray(3);
        glVertexAttribDivisor(3, 1);
        glVertexAttribPointer(3, 4, GL_FLOAT, GL_FALSE, sizeof(ParticleInstanceData), (GLvoid *) offsetof(ParticleInstanceData, col2));
        glEnableVertexAttribArray(4);
        glVertexAttribDivisor(4, 1);
        glVertexAttribPointer(4, 4, GL_FLOAT, GL_FALSE, sizeof(ParticleInstanceData), (GLvoid *) offsetof(ParticleInstanceData, col3));
        glEnableVertexAttribArray(5);
        glVertexAttribDivisor(5, 1);
        glVertexAttribPointer(5, 1, GL_INT, GL_FALSE, sizeof(ParticleInstanceData), (GLvoid *) offsetof(ParticleInstanceData, i));
        glEnableVertexAttribArray(6);
        glVertexAttribDivisor(6, 1);
        glVertexAttribPointer(6, 1, GL_INT, GL_FALSE, sizeof(ParticleInstanceData), (GLvoid *) offsetof(ParticleInstanceData, j));
        glEnableVertexAttribArray(7);
        glVertexAttribDivisor(7, 1);
        glVertexAttribPointer(7, 1, GL_FLOAT, GL_FALSE, sizeof(ParticleInstanceData), (GLvoid *) offsetof(ParticleInstanceData, blendFactor));
